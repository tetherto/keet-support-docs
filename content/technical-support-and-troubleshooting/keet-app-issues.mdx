...
* Restart the app and wait a couple of minutes for it to sync all groups. (If this is right after an update, see [Slow Groups After Updating](/technical-support-and-troubleshooting/slow-groups-after-updating) — a delay opening groups the first time is expected.)
